...
impl Device {
    ...
    fn create_generic_surface(
        ...
        info!("create_generic_surface");
        let _guard = self.temporarily_make_context_current(context)?;

        info!("temporarily_make_context_current: guard start");
        GL_FUNCTIONS.with(|gl| {
            unsafe {
                // Create a native hardware buffer.
                let hardware_buffer_desc = OH_NativeBuffer_Config {
                    format: OH_NativeBuffer_Format::NATIVEBUFFER_PIXEL_FMT_RGBA_8888 as i32,
                    height: size.height,
                    width: size.width,
                    stride: 10,
                ...
                info!("bind_to_current_framebuffer ...");
                ...
                SurfaceObjects::HardwareBuffer {
                    ...
                    GL_FUNCTIONS.with(|gl| {
                        ...
                        *egl_image = EGL_NO_IMAGE_KHR;
                        ...
                        OH_NativeBuffer_Unreference(*hardware_buffer);
